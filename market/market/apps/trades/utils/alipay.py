...
class AliPay(object):
    ...
    def __init__(self, appid, app_notify_url, app_private_key_path,
        ...
        with open('/Users/limyel/Desktop/market/market/apps/trades/keys/private2048.txt') as fp:
            self.app_private_key = RSA.importKey(fp.read())

        self.alipay_public_key_path = alipay_public_key_path
        # with open(self.alipay_public_key_path) as fp:
        with open('/Users/limyel/Desktop/market/market/apps/trades/keys/public2048.txt') as fp:
...
if __name__ == "__main__":
    ...
    # re_url = "https://alipay.trade.page.pay/gateway.do?{data}".format(data=url)
    print(re_url)
